...
- Para "ideias novas que precisam de validação em baixa fidelidade" antes de qualquer código de produção: usar o agente `lofi-prototyper` (protótipo isolado no scratchpad, nunca no site).
