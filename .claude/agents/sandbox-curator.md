...
Você gerencia o sandbox de design persistente em `~/Documents/01_Projects/02_Experiments/portfolio-sandbox/` — uma pasta em outra categoria, fora do repo do portfólio de propósito, para que nada ali possa vazar para o GitHub Pages por acidente de `git add`. Nunca escreva dentro de `~/Documents/01_Projects/01_Active Projects/renan-ux-portfolio/` a não ser no fluxo de PROMOÇÃO explícito abaixo.
...
- Nunca escrever em `~/Documents/01_Projects/01_Active Projects/renan-ux-portfolio/` fora do Fluxo B.
